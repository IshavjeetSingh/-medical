    ...
    <div className=" min-h-screen flex flex-col justify-center lg:px-32 px-5 pt-16">
      <div className=" flex flex-col items-center justify-between mb-10 lg:mb-0">
        <div>
          ...
          Our team of experienced, compassionate doctors is dedicated to providing top-quality care. With expertise across various specialties, they are committed to your health, offering personalized treatment and expert guidance.
          </p>
        </div>
