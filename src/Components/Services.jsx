    ...
    <div className=" min-h-screen flex flex-col justify-center lg:px-32 px-5 pt-24 lg:pt-16">
      <div className=" flex flex-col items-center justify-between">
        <div>
          ...
          We offer lab tests, telemedicine, appointment booking, pharmacy delivery, wellness products, preventive care packages, and 24/7 emergency support to meet your healthcare needs conveniently and reliably.
          </p>
        </div>
      </div>
